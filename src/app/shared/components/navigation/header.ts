      ...
      <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        ...
        >
          <button
            ...
            [class]="{ 'bg-gray-100': isMobileOpen(), 'dark:bg-white/[0.03]': isMobileOpen() }"
            (click)="handleToggle()"
        ...
        <div
          ...
          [class]="{ flex: applicationMenu(), hidden: !applicationMenu() }"
        >
...
export class Header {
  ...
  toggleApplicationMenu() {
    this.applicationMenu.set(!this.applicationMenu());
  }
